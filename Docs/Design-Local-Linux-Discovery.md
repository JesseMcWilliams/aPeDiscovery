...
- **Found and fixed a real, significant bug**: `CLIPasswordSDK.exe GetPassword /o Password,PassProps.UserName`
  ...
  `ThisIsMy_FAKE_Password6!,CAscanner2`), never `Key=Value` pairs — confirmed by probing with non-secret
